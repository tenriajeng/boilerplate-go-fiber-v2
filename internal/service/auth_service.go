...
func NewAuthService(userRepo repository.UserRepository, authRepo repository.AuthRepository, userService service.UserService, config *config.Config) service.AuthService {
	return &authService{
		userRepo:    userRepo,
		authRepo:    authRepo,
